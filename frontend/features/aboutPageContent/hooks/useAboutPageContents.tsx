...
export function useAboutPageContents() {
  ...
  const {
    ...
    queryFn: async ({ signal }) => {
      ...
      const response = await aboutPageContentService.getAllAboutPageContents(combinedSignal);
      
      if (isSuccessResponse(response)) {
        return response.data;
      }
      throw new Error(response.message || "Failed to fetch about page contents");
    },
  });
