...
export function useClientsPartnersSections() {
  ...
  const {
    ...
    queryKey: ["clientsPartnersSections"],
    queryFn: async ({ signal }) => {
      ...
      const response = await clientsPartnersSectionService.getAllClientsPartnersSections(combinedSignal);
      
      if (isSuccessResponse(response)) {
        return response.data;
      }
      throw new Error(response.message || "Failed to fetch clients & partners sections");
    },
  });
