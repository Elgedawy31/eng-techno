...
export function useAboutPageHeroes() {
  ...
  const {
    ...
    queryFn: async ({ signal }) => {
      ...
      const response = await aboutPageHeroService.getAllAboutPageHeroes(combinedSignal);
      
      if (isSuccessResponse(response)) {
        return response.data;
      }
      throw new Error(response.message || "Failed to fetch about page heroes");
    },
  });
